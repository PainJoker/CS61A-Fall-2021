...
def subseqs(s):
    ...
    if s == []:
        ...
        first, rest_subseqs = s[0], subseqs(s[1:])
        return rest_subseqs + insert_into_all(first, rest_subseqs)
...
def num_trees(n):
    ...
    *   *        *       *
    ...
    if n == 1:
        ...
        # Considerate a concrete full binary tree which has 2 leaves
        # and distribute leaves to different branches.
...
class Account:
    ...
    def __init__(self, account_holder):
        ...
        self.transactions = []
        self.wnum, self.dnum = 0, 0

    def deposit(self, amount):
        """Increase the account balance by amount, add the deposit
        to the transaction history, and return the new balance.
        """
        self.balance, self.dnum = self.balance + amount, self.dnum + 1
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            ...
            self.balance, self.wnum = self.balance - amount, self.wnum + 1
    ...
    def __repr__(self):
        return f"Accountholder: {self.holder}, Deposits: {self.dnum}, Withdraws: {self.wnum}"
...
def long_paths(t, n):
    ...
    return [path for path in all_paths(t) if len(path) - 1 >= n]
